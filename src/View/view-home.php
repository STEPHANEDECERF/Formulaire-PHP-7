                ...
                <div class="card col-lg-3 col-11">
                    ...
                    <div class="card-body">
                        <div class="card-body text-start">
                            ...
                            <a href="../Controller/controller-post.php?post_id=<?= $value["post_id"] ?>"><p class="card-text m-0 text-secondary text-truncate">Afficher les 20 commentaires</p></a>
                            <a href="../Controller/controller-post.php?post_id=<?= $value["post_id"] ?>"><p class="card-text m-0 text-secondary">Ajouter un commentaire...</p></a>
